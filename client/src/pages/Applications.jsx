        ...
        <div className='flex gap-2 mb-6 mt-3 '>
          {
            ...
            <div className='flex gap-2'>
              <a className='bg-blue-100 text-blue-600 px-4 py-4 rounded-lg ' href=''>Resume</a>
          ...
          <tbody>
            {
              jobsApplied.map((job,index)=> true ? (<tr>
                <td className='flex items-center gap-2 border-b px-3 py-4'> <img className='w-8 h-8' src={job.logo} /> 
                {job.company} </td>
