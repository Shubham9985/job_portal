...
const RecruiterLogin = () => {
    ...
    const [isTextDataSubmited, setIsTextSubmited] = useState(false)
            ...
            <form onSubmit={onSubmitHandler} className='relative bg-white p-10 rounded-xl text-slate-500 '>
                ...
                {state === "Sign Up" && isTextDataSubmited ?
                    ...
                    <>
                        ...
                        {state !== 'Login' && (
                            <div className='border px-4 py-2 items-center flex gap-2 rounded-full mt-5'>
                ...
                {state === 'Login' && <p className='text-sm text-blue-400 mt-4 cursor-pointer'>Forgot Password ?</p> }
